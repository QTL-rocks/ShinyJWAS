...
#### Important Note: given the time limit of the online server, we highly recommend using _runGitHub("ShinyJWAS","QTL-rocks",subdir = "shinyjwas")_ to run the shiny app locally.
---------------
